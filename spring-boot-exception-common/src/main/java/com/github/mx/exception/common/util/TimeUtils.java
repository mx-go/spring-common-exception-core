...
public class TimeUtils {
    ...
    public static LocalTime parseTime(String time, String pattern) {
        CommonErrorCode.DATE_NOT_NULL.assertNotEmpty(time);
    ...
    private static String checkNotEmpty(String time, boolean nullable) {
        ...
        if (!nullable) {
            CommonErrorCode.DATE_NOT_NULL.assertFail(time);
        }
        return null;
    }
    ...
    private static DateTimeFormatter getFormatter(String pattern) {
        CommonErrorCode.PATTERN_NOT_NULL.assertNotEmpty(pattern);
    ...
    public static long getBetweenSeconds(LocalDateTime startDateTime, LocalDateTime endDateTime) {
        CommonErrorCode.DATETIME_NOT_NULL.assertNotNull(startDateTime);
        CommonErrorCode.DATETIME_NOT_NULL.assertNotNull(endDateTime);
    ...
    public static long getBetweenSeconds(LocalTime startTime, LocalTime endTime) {
        CommonErrorCode.TIME_NOT_NULL.assertNotNull(startTime);
        CommonErrorCode.TIME_NOT_NULL.assertNotNull(endTime);
